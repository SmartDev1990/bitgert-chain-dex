    ...
    test('BRISE to DAI', () => {
      expect(
        queryParametersToSwapState(
          parse(
            '?inputCurrency=BRISE&outputCurrency=0x6b175474e89094c44da98b954eedeac495271d0f&exactAmount=20.5&exactField=outPUT',
            { parseArrays: false, ignoreQueryPrefix: true }
          )
        )
      ).toEqual({
        [Field.OUTPUT]: { currencyId: '0x6B175474E89094C44Da98b954EedeAC495271d0F' },
        [Field.INPUT]: { currencyId: 'BRISE' },
        typedValue: '20.5',
